...
var ProvinciaService = (function () {
    function ProvinciaService(http, config) {
        this.http = http;
        this.config = config;
    }
    ProvinciaService.prototype.getAll = function () {
        return this.http.get(this.config.apiUrl + 'domicilio/provincias', function (response) { return response.json(); });
    };
    ProvinciaService.prototype.getById = function (id) {
        return this.http.get(this.config.apiUrl + 'users/' + id, this.jwt()).map(function (response) { return response.json(); });
    };
    ProvinciaService.prototype.create = function (obj) {
        return this.http.post(this.config.apiUrl + 'register', obj);
    };
    ProvinciaService.prototype.update = function (obj) {
        return this.http.put(this.config.apiUrl + 'users/' + obj.id, obj, this.jwt());
    };
    ProvinciaService.prototype.delete = function (id) {
        return this.http.delete(this.config.apiUrl + 'users/' + id, this.jwt());
    };
    // private helper methods
    ProvinciaService.prototype.jwt = function () {
