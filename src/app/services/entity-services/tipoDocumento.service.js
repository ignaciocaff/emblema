...
var TipoDocumentoService = (function () {
    function TipoDocumentoService(http, config) {
        this.http = http;
        this.config = config;
    }
    TipoDocumentoService.prototype.getAll = function () {
        return this.http.get(this.config.apiUrl + 'personas/tiposdoc', function (response) { return response.json(); });
    };
    TipoDocumentoService.prototype.getById = function (id) {
        return this.http.get(this.config.apiUrl + 'users/' + id, this.jwt()).map(function (response) { return response.json(); });
    };
    TipoDocumentoService.prototype.create = function (obj) {
        return this.http.post(this.config.apiUrl + 'register', obj);
    };
    TipoDocumentoService.prototype.update = function (obj) {
        return this.http.put(this.config.apiUrl + 'users/' + obj.id, obj, this.jwt());
    };
    TipoDocumentoService.prototype.delete = function (id) {
        return this.http.delete(this.config.apiUrl + 'users/' + id, this.jwt());
    };
    // private helper methods
    TipoDocumentoService.prototype.jwt = function () {
