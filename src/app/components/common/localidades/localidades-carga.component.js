...
var LocalidadesCargaComponent = (function () {
    function LocalidadesCargaComponent(dialogRef, provinciaService, localidadService, toastr, data) {
    ...
    LocalidadesCargaComponent.prototype.registrarLocalidad = function () {
        ...
        this.localidadService.create(this.localidad).subscribe(function (data) {
            ...
            _this.blockUI.stop();
            _this.toastr.error("El nombre de esa localidad ya existe", "Error!");
        });
    };
