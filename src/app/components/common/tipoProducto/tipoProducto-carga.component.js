...
var TipoProductoCargaComponent = (function () {
    function TipoProductoCargaComponent(dialogRef, tipoProductoService, toastr) {
    ...
    TipoProductoCargaComponent.prototype.registrarTipoProducto = function () {
        ...
        this.tipoProductoService.create(this.tipoProducto).subscribe(function (data) {
            ...
            _this.toastr.success("El tipo de producto fue creado correctamente", "Exito!");
        }, function (error) {
            _this.blockUI.stop();
            _this.toastr.error("El nombre de ese tipo de producto ya existe", "Error!");
        });
    };
